...
SELECT COUNT(DISTINCT City) AS Unique_City FROM EMP;
...
SELECT Department,MAX(Salary) AS Max_Salary FROM EMP
GROUP BY Department;
...
SELECT AVG(Salary) AS Avg_Salary_Department FROM EMP
GROUP BY Department;
...
SELECT ENAME,Department,Salary FROM EMP
WHERE Salary in (
